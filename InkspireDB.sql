...
VALUES
('kim', 'uploads/default.png', 'Test teacher Kim',  (SELECT user_id FROM User WHERE username = 'kim')),
('søren', 'uploads/default.png', 'Test teacher Søren', (SELECT user_id FROM User WHERE username = 'søren'));
